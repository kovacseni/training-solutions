...
public class Registration {
    ...
    public void registrate() throws SQLException {
        ...
        service.writeIntoDatabase(new Person(name, postalCode, age, email, ssn));

        System.out.println();
        System.out.println("Regisztrációja sikeresen megtörtént, a továbbiakról az Ön által megadott e-mail címen tájékoztatjuk.");
    }
