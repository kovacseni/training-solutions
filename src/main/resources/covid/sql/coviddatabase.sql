CREATE DATABASE if NOT EXISTS covid DEFAULT CHARACTER SET UTF8 COLLATE UTF8_HUNGARIAN_CI;

CREATE USER 'coviduser' IDENTIFIED BY 'covidpassword';

GRANT ALL ON *.* TO 'coviduser';
