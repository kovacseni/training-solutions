...
public class ActivityDaoTest {
    ...
    private DatabaseMetadataDao dataDao;
    ...
    public void setUp() throws SQLException {
        ...
        /*Flyway fw = Flyway.configure().locations("/db/migration/activitytracker").dataSource(dataSource).load();
        fw.clean();
        fw.migrate();*/
        ...
        dao.insertActivitiesFromList(activities);
    }
    ...
    @Test
    public void testSaveActivityAndReturnGeneratedKeys() {
    ...
    @Test
    public void testSaveActivitywithTrackPointsEverythingIsOK() {
    ...
    @Test
    public void testSaveActivitywithTrackPointsSomethingIsWrong() {
        TrackPoint trackPoint1 = new TrackPoint(LocalDate.of(2021, 2, 24), 47.2181020, 18.5411940);
        TrackPoint trackPoint2 = new TrackPoint(LocalDate.of(2021, 2, 24), 47.2181230, 18.5411780);
    ...
    @Test
    public void testActivitiesBeforeDate() {
    ...
    @Test
    public void testSaveAndLoadImage() throws IOException {
    ...
    public void testMetaData() {
        ...
        Assertions.assertTrue(columnsForActivities.contains("activity_desc"));
    ...
    @Test
    public void testSomeTrackPoints() {
        testSaveActivitywithTrackPointsEverythingIsOK();
        TrackPoint trackPoint1 = new TrackPoint(LocalDate.of(2021, 2, 24), 47.2181020, 18.5411940);
        TrackPoint trackPoint3 = new TrackPoint(LocalDate.of(2020, 12, 14), 47.2302470, 18.5472280);
        TrackPoint trackPoint5 = new TrackPoint(LocalDate.of(2020, 12, 14), 47.2302552, 18.5472312);

        List<TrackPoint> expected = dao.someTrackPoints(6);

        Assertions.assertEquals(3, expected.size());
        Assertions.assertEquals(trackPoint1, expected.get(0));
        Assertions.assertEquals(trackPoint3, expected.get(1));
        Assertions.assertEquals(trackPoint5, expected.get(2));
    }
}